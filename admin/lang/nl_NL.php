...
* @Update		Ren� Bakkers (2.03) | getsimple.dare-is.nl, Kim Ausloos (3.1) | leenmoerland.com, Leen Moerland (3.2) | Mediascape, Arno Bakker (3.3)
*
*****************************************************/
...
"SITEMAP_ERRORPING"		=>	"Sitemap gecre&euml;erd, maar er is wel een fout geconstateerd bij ��n of meerder zoekmachines tijdens het pingen",
"SITEMAP_ERROR"			=>	"Het is niet mogelijk om uw sitemap te genereren",
"SITEMAP_WAIT"			=>	"<b>Wacht a.u.b:</b> Sitemap website wordt gecre�erd",
...
"CREATE_ARC_WAIT"		=>	"<b>Wacht a.u.b.:</b> Webiste archief wordt gecre�erd...",
